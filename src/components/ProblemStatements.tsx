...
const problems = [
  ...
  },
  {
    ...
    description: "Develop an AI-powered train traffic control system that optimizes section throughput by precisely managing train movements and schedules.",
    color: "text-accent",
    bgGradient: "from-accent/10 to-accent/5",
  },
  {
    ...
    category: "EdTech",
    description: "Create an intelligent system that optimizes classroom allocation and automatically generates efficient timetables based on various constraints and preferences.",
    color: "text-primary",
    bgGradient: "from-primary/10 to-primary/5",
  },
  {
    ...
    category: "EdTech",
    description: "Build an automated attendance tracking system with analytics capabilities to monitor student attendance patterns and generate insights for colleges.",
    color: "text-secondary",
    bgGradient: "from-secondary/10 to-secondary/5",
  },
  {
    ...
    description: "Design a comprehensive platform for managing alumni data, facilitating networking, and maintaining engagement between alumni and their institutions.",
    color: "text-accent",
    bgGradient: "from-accent/10 to-accent/5",
  },
  {
    ...
    category: "EdTech",
    description: "Develop an automated, cost-effective attendance system tailored for rural schools with limited infrastructure and connectivity.",
    color: "text-primary",
    bgGradient: "from-primary/10 to-primary/5",
  },
  {
